...
const EditButton = ({ onClick }) => {
  return <Button icon={<Icons.Edit />} onClick={onClick} label="Modify" />;
};
...
const AddButton = ({ onClick }) => {
  return <Button icon={<Icons.Add />} onClick={onClick} label="Add" />;
};

const SubmitButton = ({ onClick }) => {
  return <Button icon={<Icons.Submit />} onClick={onClick} label="Submit" />;
};

const CancelButton = ({ onClick }) => {
  return <Button icon={<Icons.Cancel />} onClick={onClick} label="Cancel" />;
};
...
Action.SubmitButton = SubmitButton;
